...
unset($__errorArgs, $__bag); ?>"
                   value="<?php echo e(old('title', $delegation->title ?? '')); ?>" 
                   required
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <select name="entity_type" 
                        class="form-select <?php $__errorArgs = ['entity_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <option value="state_member" <?php if(old('entity_type', $delegation->entity_type ?? '') == 'state_member'): echo 'selected'; endif; ?>>
                        État membre
                    </option>
                    <option value="international_organization" <?php if(old('entity_type', $delegation->entity_type ?? '') == 'international_organization'): echo 'selected'; endif; ?>>
                        Organisation internationale
                    </option>
                    <option value="technical_partner" <?php if(old('entity_type', $delegation->entity_type ?? '') == 'technical_partner'): echo 'selected'; endif; ?>>
                        Partenaire technique
                    </option>
                    <option value="financial_partner" <?php if(old('entity_type', $delegation->entity_type ?? '') == 'financial_partner'): echo 'selected'; endif; ?>>
                        Partenaire financier
                    </option>
                    <option value="other" <?php if(old('entity_type', $delegation->entity_type ?? '') == 'other'): echo 'selected'; endif; ?>>
                        Autre
                    </option>
                </select>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('country', $delegation->country ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('organization_name', $delegation->organization_name ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <select name="meeting_id" 
                    class="form-select <?php $__errorArgs = ['meeting_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                ...
                <?php $__currentLoopData = $meetings ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($meeting->id); ?>" 
                            <?php if(old('meeting_id', $delegation->meeting_id ?? $meetingId ?? request('meeting_id')) == $meeting->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            <?php if(request('meeting_id') && !old('meeting_id')): ?>
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Description de la délégation..."><?php echo e(old('description', $delegation->description ?? '')); ?></textarea>
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="text" 
                       ...
                       class="form-control <?php $__errorArgs = ['head_of_delegation_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('head_of_delegation_name', $delegation->head_of_delegation_name ?? '')); ?>"
                       placeholder="Ex: Jean KABILA">
                <?php $__errorArgs = ['head_of_delegation_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" 
                       ...
                       class="form-control <?php $__errorArgs = ['head_of_delegation_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('head_of_delegation_position', $delegation->head_of_delegation_position ?? '')); ?>"
                       placeholder="Ex: Ministre des Affaires Étrangères">
                <?php $__errorArgs = ['head_of_delegation_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="email" 
                       ...
                       class="form-control <?php $__errorArgs = ['head_of_delegation_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('head_of_delegation_email', $delegation->head_of_delegation_email ?? '')); ?>">
                <?php $__errorArgs = ['head_of_delegation_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('contact_email', $delegation->contact_email ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('contact_phone', $delegation->contact_phone ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row g-3 mt-2">
            ...
            <select name="participation_status" 
                    class="form-select <?php $__errorArgs = ['participation_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                <option value="invited" <?php if(old('participation_status', $delegation->participation_status ?? 'invited') == 'invited'): echo 'selected'; endif; ?>>
                    Invité
                </option>
                <option value="confirmed" <?php if(old('participation_status', $delegation->participation_status ?? '') == 'confirmed'): echo 'selected'; endif; ?>>
                    Confirmé
                </option>
                <option value="registered" <?php if(old('participation_status', $delegation->participation_status ?? '') == 'registered'): echo 'selected'; endif; ?>>
                    Inscrit
                </option>
                <option value="present" <?php if(old('participation_status', $delegation->participation_status ?? '') == 'present'): echo 'selected'; endif; ?>>
                    Présent
                </option>
                <option value="absent" <?php if(old('participation_status', $delegation->participation_status ?? '') == 'absent'): echo 'selected'; endif; ?>>
                    Absent
                </option>
                <option value="excused" <?php if(old('participation_status', $delegation->participation_status ?? '') == 'excused'): echo 'selected'; endif; ?>>
                    Excusé
                </option>
            </select>
            <?php $__errorArgs = ['participation_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Notes additionnelles..."><?php echo e(old('notes', $delegation->notes ?? '')); ?></textarea>
        ...
        <div id="members_container">
            ...
            <?php if(!empty($members)): ?>
                <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php echo $__env->make('delegations._member_form', [
                        'index' => $index,
                        'member' => $member,
...
(function() {
    ...
    // Variables globales
    let memberIndex = <?php echo e(!empty($members) ? count($members) : 0); ?>;
    ...
    if (addMemberBtn && membersContainer && memberTemplate) {
        ...
        setTimeout(function() {
            <?php if(session('success')): ?>
                ...
                console.log('✅ Message de succès affiché:', <?php echo json_encode(session('success'), 15, 512) ?>);
            <?php endif; ?>
            
            <?php if(session('error')): ?>
                showToast(<?php echo json_encode(session('error'), 15, 512) ?>, 'error');
                console.log('❌ Message d\'erreur affiché:', <?php echo json_encode(session('error'), 15, 512) ?>);
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\sgrs-alpha\resources\views/delegations/_form.blade.php ENDPATH**/ ?>