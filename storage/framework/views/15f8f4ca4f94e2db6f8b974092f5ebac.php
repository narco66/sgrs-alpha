        ...
        <form method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
                ...
                <select name="event" class="form-select">
                    ...
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($eventValue); ?>" <?php if(request('event') === $eventValue): echo 'selected'; endif; ?>>
                            <?php echo e($eventValue); ?>
            ...
            <div class="col-md-3">
                ...
                <input type="number" name="user_id" value="<?php echo e(request('user_id')); ?>" class="form-control" placeholder="ID utilisateur">
            </div>
            <div class="col-md-4">
                <label class="form-label">Modèle concerné</label>
                <input type="text" name="model" value="<?php echo e(request('model')); ?>" class="form-control" placeholder="Ex : App\Models\Meeting">
            </div>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="small text-muted">
                    Total : <?php echo e($logs->total()); ?> action(s)
                </span>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><span class="badge bg-primary"><?php echo e($log->event); ?></span></td>
                                <td class="small">
                                    <?php if($log->user): ?>
                                        #<?php echo e($log->user_id); ?> – <?php echo e($log->user->name); ?>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-secondary"
                                            ...
                                            data-bs-target="#log-details-<?php echo e($log->id); ?>">
                                        Détails
                                    </button>
                                </td>
                            </tr>
                            <tr class="collapse bg-light" id="log-details-<?php echo e($log->id); ?>">
                                <td colspan="7">
                                    <div class="p-3 small">
                                        <div class="mb-2">
                                            <strong>User Agent :</strong>
                                            <span class="text-muted"><?php echo e($log->user_agent ?? '-'); ?></span>
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <h6 class="fw-semibold small mb-1">Anciennes valeurs</h6>
                                                <pre class="small bg-white border rounded p-2 mb-0" style="max-height: 200px; overflow:auto;"><?php echo e(json_encode($log->old_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)); ?></pre>
                                            </div>
                                            <div class="col-md-6">
                                                <h6 class="fw-semibold small mb-1">Nouvelles valeurs</h6>
                                                <pre class="small bg-white border rounded p-2 mb-0" style="max-height: 200px; overflow:auto;"><?php echo e(json_encode($log->new_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)); ?></pre>
                                            </div>
                                        </div>
                                        <?php if(!empty($log->meta)): ?>
                                            <div class="mt-3">
                                                <h6 class="fw-semibold small mb-1">Meta</h6>
                                                <pre class="small bg-white border rounded p-2 mb-0" style="max-height: 200px; overflow:auto;"><?php echo e(json_encode($log->meta, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)); ?></pre>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
        ...
        <?php if($logs->hasPages()): ?>
            <div class="card-footer d-flex justify-content-between align-items-center">
                <div class="small text-muted">
                    ...
                    sur <?php echo e($logs->total()); ?> entrée(s).
                </div>
                <div>
