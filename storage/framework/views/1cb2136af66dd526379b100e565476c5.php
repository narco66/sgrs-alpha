...
<head>
    ...
    <title>
        <?php if (! empty(trim($__env->yieldContent('title')))): ?>
            <?php echo $__env->yieldContent('title'); ?> – SGRS-CEEAC
        <?php else: ?>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/ceeac-logo.png')); ?>">
            ...
            <div class="flex-grow-1 p-3">
                ...
                <ul class="nav nav-pills flex-column gap-1">
                    ...
                    <li class="nav-item">
                        ...
                        class="nav-link <?php echo e(request()->routeIs('meetings.*') ? 'active' : ''); ?>">
                    ...
                    <li class="nav-item">
                        ...
                        class="nav-link <?php echo e(request()->routeIs('participants.*') ? 'active' : ''); ?>">
                            <i class="bi bi-person-lines-fill"></i>
                            <span>Participants</span>
                        </a>
                    </li>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delegations.view')): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('delegations.index')); ?>"
                            class="nav-link <?php echo e(request()->routeIs('delegations.*') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-pills flex-column gap-1 nav-submenu">
                        <li class="nav-item">
                            <button class="nav-link w-100 d-flex justify-content-between align-items-center
                                        <?php echo e(request()->routeIs('meeting-types.*') || request()->routeIs('committees.*') || request()->routeIs('rooms.*') ? 'active' : ''); ?>"
                                    type="button"
                                    data-bs-toggle="collapse"
                                    data-bs-target="#submenuMeetingsConfig"
                                    aria-expanded="<?php echo e(request()->routeIs('meeting-types.*') || request()->routeIs('committees.*') || request()->routeIs('rooms.*') ? 'true' : 'false'); ?>"
                            ...
                            <div class="collapse <?php echo e(request()->routeIs('meeting-types.*') || request()->routeIs('committees.*') || request()->routeIs('rooms.*') ? 'show' : ''); ?>"
                                id="submenuMeetingsConfig">
                                <ul class="nav flex-column mt-1">

                                    
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('meeting-types.index')); ?>"
                                        class="nav-link nav-link-sub <?php echo e(request()->routeIs('meeting-types.*') ? 'active' : ''); ?>">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('committees.index')); ?>"
                                        class="nav-link nav-link-sub <?php echo e(request()->routeIs('committees.*') ? 'active' : ''); ?>">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        class="nav-link nav-link-sub <?php echo e(request()->routeIs('rooms.*') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-pills flex-column gap-1 nav-submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.view')): ?>
                            <li class="nav-item">
                                ...
                                class="nav-link nav-link-sub <?php echo e(request()->routeIs('users.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user() && auth()->user()->hasRole('super-admin')): ?>
                            <li class="nav-item">
                                ...
                                class="nav-link nav-link-sub <?php echo e(request()->routeIs('roles.*') ? 'active' : ''); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('document_types.view')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('document-types.index')); ?>"
                                class="nav-link nav-link-sub <?php echo e(request()->routeIs('document-types.*') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item">
                            ...
                            class="nav-link nav-link-sub <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('audit_logs.view')): ?>
                            <li class="nav-item">
                                ...
                                class="nav-link nav-link-sub <?php echo e(request()->routeIs('audit-logs.*') ? 'active' : ''); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage settings')): ?>
                            <li class="nav-item">
                                ...
                                class="nav-link nav-link-sub <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>">
            ...
            <div class="flex-grow-1 d-flex flex-column">
                ...
                <nav class="navbar navbar-expand-md navbar-light bg-white sgrs-topbar">
                    <div class="container-fluid">
                        ...
                        <span class="navbar-brand d-md-none">
                            <img src="<?php echo e(asset('images/ceeac-logo.png')); ?>"
                                 alt="CEEAC"
                                 width="28"
                                 height="28"
                ...
                <main class="flex-grow-1">
                    <div class="container-fluid py-4">
                        ...
                        <?php echo $__env->renderWhen(View::exists('partials.alerts'), 'partials.alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
