...
unset($__errorArgs, $__bag); ?>">
                        <option value="active" <?php if(old('status', 'active') === 'active'): echo 'selected'; endif; ?>>Actif</option>
                        <option value="inactive" <?php if(old('status') === 'inactive'): echo 'selected'; endif; ?>>Inactif</option>
                        <option value="pending" <?php if(old('status') === 'pending'): echo 'selected'; endif; ?>>En attente de validation</option>
                        <option value="rejected" <?php if(old('status') === 'rejected'): echo 'selected'; endif; ?>>Rejeté</option>
                    </select>
