...
<head>
    ...
    <title>Cahier des charges - <?php echo e($meeting->title); ?></title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h2>Entre la CEEAC et le <?php echo e($termsOfReference->host_country); ?></h2>
        <p style="margin-top: 10px; color: #666;">
            Réunion : <?php echo e($meeting->title); ?><br>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <span><?php echo e($termsOfReference->host_country); ?></span>
        </div>
        <?php if($termsOfReference->signature_date): ?>
            <div class="info-row">
                <span class="info-label">Date de signature :</span>
                <span><?php echo e($termsOfReference->signature_date->format('d/m/Y')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <div class="info-row">
            ...
            <span><?php echo e(ucfirst($termsOfReference->status)); ?></span>
        </div>
    </div>

    <div class="content-section">
        <h4>1. RESPONSABILITÉS DE LA CEEAC</h4>
        <div class="content-text"><?php echo e($termsOfReference->responsibilities_ceeac ?? 'Non renseigné'); ?></div>
    </div>

    <div class="content-section">
        <h4>2. RESPONSABILITÉS DU PAYS HÔTE</h4>
        <div class="content-text"><?php echo e($termsOfReference->responsibilities_host ?? 'Non renseigné'); ?></div>
    </div>

    <?php if($termsOfReference->financial_sharing): ?>
        <div class="content-section">
            <h4>3. PARTAGE DES CHARGES FINANCIÈRES</h4>
            <div class="content-text"><?php echo e($termsOfReference->financial_sharing); ?></div>
        </div>
    <?php endif; ?>
    ...
    <?php if($termsOfReference->logistical_sharing): ?>
        <div class="content-section">
            ...
            <div class="content-text"><?php echo e($termsOfReference->logistical_sharing); ?></div>
        </div>
    <?php endif; ?>
    ...
    <?php if($termsOfReference->obligations_ceeac || $termsOfReference->obligations_host): ?>
        <div class="content-section">
            ...
            <?php if($termsOfReference->obligations_ceeac): ?>
                ...
                <div class="content-text"><?php echo e($termsOfReference->obligations_ceeac); ?></div>
            <?php endif; ?>
            <?php if($termsOfReference->obligations_host): ?>
                <h5 style="margin-top: 15px; font-size: 13px;">5.2. Obligations du pays hôte</h5>
                <div class="content-text"><?php echo e($termsOfReference->obligations_host); ?></div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if($termsOfReference->additional_terms): ?>
        <div class="content-section">
            ...
            <div class="content-text"><?php echo e($termsOfReference->additional_terms); ?></div>
        </div>
    <?php endif; ?>
    ...
    <?php if($termsOfReference->notes): ?>
        <div class="content-section">
            <h4>7. NOTES</h4>
            <div class="content-text"><?php echo e($termsOfReference->notes); ?></div>
        </div>
    <?php endif; ?>
        ...
        <div class="signature-section">
            ...
            <div class="signature-box">
                ...
                <?php if($termsOfReference->signerCeeac): ?>
                    <div style="margin-top: 10px;"><?php echo e($termsOfReference->signerCeeac->name); ?></div>
                <?php endif; ?>
            ...
            <div class="signature-box">
                <strong>Pour le <?php echo e($termsOfReference->host_country); ?> :</strong>
                <?php if($termsOfReference->signed_by_host_name): ?>
                    <div style="margin-top: 10px;"><?php echo e($termsOfReference->signed_by_host_name); ?></div>
                    <?php if($termsOfReference->signed_by_host_position): ?>
                        <div style="font-size: 11px; color: #666;"><?php echo e($termsOfReference->signed_by_host_position); ?></div>
                    <?php endif; ?>
                <?php endif; ?>
                <div class="signature-line">
                    Signature et cachet
...
<?php /**PATH C:\laragon\www\sgrs-alpha\resources\views\terms-of-reference\pdf.blade.php ENDPATH**/ ?>