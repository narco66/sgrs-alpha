<?php $__env->startSection('title', 'Accueil institutionnel'); ?>
            ...
            <div class="card-body py-3 py-md-4">
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    ...
                    <nav class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-primary ms-md-2">
    ...
    <footer class="pb-2">
        <div class="card border-0 shadow-sm">
            <div class="card-body py-3 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 small">
                <div>
                    © <?php echo e(date('Y')); ?> Commission de la CEEAC – Tous droits réservés.
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sgrs-alpha\resources\views/home.blade.php ENDPATH**/ ?>