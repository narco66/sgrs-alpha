...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('end_date', $meeting->end_at ? $meeting->end_at->format('Y-m-d') : ($meeting->start_at?->format('Y-m-d') ?? now()->format('Y-m-d')))); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('end_time', $meeting->end_at ? $meeting->end_at->format('H:i') : ($meeting->start_at?->copy()->addMinutes($meeting->duration_minutes ?? 60)->format('H:i') ?? ''))); ?>"
                                       required>
