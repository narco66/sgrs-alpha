...
unset($__errorArgs, $__bag); ?>"
                                            required
                                            <?php if(auth()->user()->can('meeting_types.create')): ?> ondblclick="window.quickCreateMeetingType && window.quickCreateMeetingType();" <?php endif; ?>>
                                    ...
                                    <?php if(auth()->user()->can('meeting_types.create')): ?>
                                        <button type="button"
...
unset($__errorArgs, $__bag); ?>"
                                            <?php if(auth()->user()->can('committees.create')): ?> ondblclick="window.quickCreateCommittee && window.quickCreateCommittee();" <?php endif; ?>>
                                    ...
                                    <?php if(auth()->user()->can('committees.create')): ?>
                                        <button type="button"
                                                class="btn btn-outline-primary"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="configuration"
                                        id="configuration"
                                        class="form-select <?php $__errorArgs = ['configuration'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            <?php if(auth()->user()->can('create', \App\Models\Room::class)): ?> ondblclick="window.quickCreateRoom && window.quickCreateRoom();" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Moyens de transport, navettes, contacts..."><?php echo e(old('logistics_transport')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Hôtels, réservations, contacts..."><?php echo e(old('logistics_accommodation')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Repas officiels, traiteurs, menus..."><?php echo e(old('logistics_catering')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Organisation des pauses café..."><?php echo e(old('logistics_coffee_breaks')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Configuration, plan de salle, agencement..."><?php echo e(old('logistics_room_setup')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Équipements, besoins techniques..."><?php echo e(old('logistics_av_equipment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Langues, effectifs, cabines..."><?php echo e(old('logistics_interpreters')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Contacts, responsabilités..."><?php echo e(old('logistics_liaison_officers')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Dispositif de sécurité, accès..."><?php echo e(old('logistics_security')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Premiers secours, contacts médicaux..."><?php echo e(old('logistics_medical')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Cérémonies, accueil VIP..."><?php echo e(old('logistics_protocol')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Autres éléments logistiques..."><?php echo e(old('logistics_other')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                          rows="4"
                                          placeholder="Observations, points d'attention..."><?php echo e(old('logistics_notes')); ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    (function() {
        ...
        formQuick.addEventListener('submit', async function(e) {
            e.preventDefault();
            try {
                const data = await postJson('<?php echo e(route('meeting-types.store')); ?>', formQuick);
    ...
    (function() {
        ...
        formQuick.addEventListener('submit', async function(e) {
            e.preventDefault();
            try {
                const data = await postJson('<?php echo e(route('committees.store')); ?>', formQuick);
                if (data && data.id && data.name) {
                    const option = new Option(data.name, data.id, true, true);
    ...
    (function() {
        ...
        formQuick.addEventListener('submit', async function(e) {
            e.preventDefault();
            try {
                const data = await postJson('<?php echo e(route('rooms.store')); ?>', formQuick);
                if (data && data.id && data.name) {
                    const option = new Option(data.name, data.id, true, true);
