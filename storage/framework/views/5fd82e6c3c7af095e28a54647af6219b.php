<?php $__env->startSection('title', 'Modifier la salle'); ?>
...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(route('rooms.show', $room)); ?>"><?php echo e($room->name); ?></a>
        </li>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo e(route('rooms.show', $room)); ?>" class="btn btn-modern btn-modern-secondary">
