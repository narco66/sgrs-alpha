...
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body">
        <form method="GET" action="{{ route('reports.performance') }}" class="row g-2 align-items-end">
            <div class="col-md-4">
        ...
        <div class="card shadow-sm border-0 text-center">
            <div class="card-body">
                ...
                <h3 class="text-primary mb-2">
                    {{ $avgConvocationDelay && $avgConvocationDelay->avg_delay ? number_format($avgConvocationDelay->avg_delay, 1) : '0' }} jours
                </h3>
        ...
        <div class="card shadow-sm border-0 text-center">
            <div class="card-body">
                ...
                <h3 class="text-success mb-2">
                    {{ $avgValidationDelay && $avgValidationDelay->avg_delay ? number_format($avgValidationDelay->avg_delay, 1) : '0' }} jours
                </h3>
        ...
        <div class="card shadow-sm border-0 text-center">
            <div class="card-body">
                ...
                <h3 class="text-info mb-2">
                    {{ $avgArchivingDelay && $avgArchivingDelay->avg_delay ? number_format($avgArchivingDelay->avg_delay, 1) : '0' }} jours
                </h3>
        ...
        <div class="row">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        @if($avgConvocationDelay && $avgConvocationDelay->avg_delay)
                            @if($avgConvocationDelay->avg_delay <= 7)
                    ...
                    <li class="mb-2">
                        ...
                        @if($avgValidationDelay && $avgValidationDelay->avg_delay)
                            @if($avgValidationDelay->avg_delay <= 5)
                                <span class="badge bg-success ms-2">Objectif atteint</span>
                            @else
                                <span class="badge bg-warning ms-2">À améliorer</span>
                            @endif
            ...
            <div class="col-md-6">
                ...
                <div class="alert alert-info mb-0">
                    <ul class="mb-0 small">
                        @if($avgConvocationDelay && $avgConvocationDelay->avg_delay > 7)
                            <li>Réduire les délais de convocation en planifiant plus tôt</li>
                        @endif
                        @if($avgValidationDelay && $avgValidationDelay->avg_delay > 5)
