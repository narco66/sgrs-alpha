                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror">
                                    @foreach($statusOptions as $status)
                                        <option value="{{ $status->value }}" @selected(old('status', $meeting->status) === $status->value)>
                                            {{ $status->label() }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           value="1"
                                           @checked(old('create_terms_of_reference', false) || !$hasTerms)>
                            ...
                            <div id="terms_fields" style="display: {{ old('create_terms_of_reference', false) || !$hasTerms ? 'block' : 'none' }};">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" 
                                           ...
                                           placeholder="Ex: République du Congo"
                                           value="{{ old('terms_host_country', $meeting->termsOfReference?->host_country) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" 
                                           ...
                                           class="form-control" 
                                           value="{{ old('terms_signature_date', $meeting->termsOfReference?->signature_date?->format('Y-m-d')) }}">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="terms_responsibilities_ceeac" 
                                              class="form-control" 
                                              rows="4" 
                                              placeholder="Décrivez les responsabilités de la CEEAC...">{{ old('terms_responsibilities_ceeac', $meeting->termsOfReference?->responsibilities_ceeac) }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="terms_responsibilities_host" 
                                              class="form-control" 
                                              rows="4" 
                                              placeholder="Décrivez les responsabilités du pays hôte...">{{ old('terms_responsibilities_host', $meeting->termsOfReference?->responsibilities_host) }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="terms_financial_sharing" 
                                              class="form-control" 
                                              rows="3" 
                                              placeholder="Décrivez le partage des charges financières...">{{ old('terms_financial_sharing', $meeting->termsOfReference?->financial_sharing) }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="terms_logistical_sharing" 
                                              class="form-control" 
                                              rows="3" 
                                              placeholder="Décrivez le partage des charges logistiques...">{{ old('terms_logistical_sharing', $meeting->termsOfReference?->logistical_sharing) }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    @if($meeting->termsOfReference && $meeting->termsOfReference->signed_document_path)
                                        <div class="alert alert-info mb-2">
                                            <i class="bi bi-file-earmark-check"></i> 
                                            <strong>Document actuel :</strong> 
                                            {{ $meeting->termsOfReference->signed_document_original_name }}
                                            <a href="{{ route('terms-of-reference.download-signed', [$meeting, $meeting->termsOfReference]) }}" 
            ...
            <div class="tab-pane fade {{ $activeTab === 'delegations' ? 'show active' : '' }}" id="delegations" role="tabpanel">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        @if($meeting->delegations->count() > 0)
                            <div class="alert alert-success mb-4">
                                <i class="bi bi-check-circle"></i> 
                                <strong>{{ $meeting->delegations->count() }} délégation(s) participent à cette réunion.</strong>
                            </div>
