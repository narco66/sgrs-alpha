...
<div class="d-flex justify-content-center">
    <div class="card shadow-lg border-0" style="max-width: 900px; width: 100%;">
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Créer une nouvelle réunion</h5>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="duration_minutes" class="form-select" required>
                            @foreach([30, 60, 90, 120, 180, 240] as $minutes)
                                <option value="{{ $minutes }}" @selected(old('duration_minutes') == $minutes)>
                                    {{ $minutes }} minutes
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description"
                                  rows="4"
                                  class="form-control"
                                  placeholder="Entrez une description qui accompagnera l’invitation envoyée à chaque participant (max. 1000 mots)">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="reminder_minutes_before" class="form-select">
                            ...
                            @foreach($values as $val => $label)
                                <option value="{{ $val }}" @selected(old('reminder_minutes_before') == $val)>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    {{-- Dans le formulaire de création / édition de réunion --}}
                    <div class="mb-3">
