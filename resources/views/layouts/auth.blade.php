...
<head>
    ...
    <title>{{ config('app.name', 'SGRS-CEEAC') }} - {{ $title ?? 'Authentification' }}</title>
        ...
        <div class="auth-logo-section">
            <div class="logo-container">
                <div class="ceeac-logo">
                    <img src="{{ asset('images/logo-ceeac.png') }}" alt="CEEAC-ECCAS Logo" style="width: 100%; height: 100%; object-fit: contain;">
                </div>
